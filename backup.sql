...
(31,33,'Black',0),
(32,33,'White',1),
(42,43,'I have this option! Im correct.',1),
(43,43,'And this one too! Im not.',0),
(44,44,'Oh not correct!',0),
(45,44,'I am!',1),
(46,46,'No....',0),
(47,46,'I did!',1),
...
(9,14,'Understanding NIS2',''),
(16,25,'First meeting','You should always be sure before accusing someone....'),
(21,13,'Im the Title','And I have a recommendation'),
(88,25,'Certainty','We must always be sure we saw the crime happen'),
(89,15,'',''),
(90,13,'',''),
...
(97,14,'Business Continuity & Crisis Management','For effective risk management, it\'s essential to have a robust business continuity and disaster recovery plan that specifically addresses cyber incidents. Regular testing of backup and restoration processes is critical to ensure that your organization can quickly recover from any disruption. Strengthening these areas will help maintain operational resilience during a cyber crisis.'),
(98,14,'Supply Chain Security','To enhance your compliance with NIS2 risk management standards, it is crucial to establish robust processes for supply chain security. Ensure that you conduct regular and systematic cybersecurity assessments of your key suppliers, include comprehensive cybersecurity requirements in all contracts, and periodically review and update your supply chain risk evaluations. Strengthening these practices will help reduce vulnerabilities originating from third-party relationships and improve overall resilience.'),
(100,14,'Secure System Acquisition, Development & Maintenance','If your organization has not yet adopted comprehensive secure development practices, we strongly recommend implementing a Secure Development Life Cycle (SDLC) that integrates security into every phase of system design, development, and maintenance. Additionally, ensure regular patch management and establish a formal vulnerability management process to promptly identify, report, and remediate security issues. These practices are crucial to reducing vulnerabilities and maintaining compliance with NIS2 risk management requirements.'),
(101,14,'Assessing Effectiveness of Security Measures','Regular reviews, defined metrics, and external audits are critical to ensure that your cybersecurity controls remain effective against evolving threats. Continuously testing and improving your security measures will help maintain compliance with NIS2 and minimize risk.'),
(102,14,'Basic Cyber Hygiene & Training','Implementing basic cyber hygiene practices and ensuring regular cybersecurity training for all employees is essential. By enforcing strong password policies, maintaining endpoint protection, and conducting ongoing awareness programs, you can significantly reduce the risk of cyber incidents.'),
(103,14,'Use of Cryptography & Encryption','Ensure that sensitive data is protected through encryption both in transit and at rest. Implementing strong cryptographic measures for communications and data storage is essential to safeguard against unauthorized access and comply with NIS2 requirements.'),
(104,14,'Human Resources Security & Access Control (Including MFA)','Implement formal onboarding/offboarding procedures, enforce least-privilege access policies, and require multi-factor authentication (MFA) for critical systems. These measures help reduce the risk of unauthorized access and ensure that user accounts are properly managed in compliance with NIS2.');
...
(33,16,'Who did it????'),
(43,21,'This is a question'),
(44,21,'And this is another!'),
(46,88,'Are you sure you saw someone kill????'),
...
(59,98,'Do you evaluate the cybersecurity posture of your key suppliers and service providers?'),
(60,98,'Are cybersecurity requirements (e.g., compliance with specific security standards, incident reporting obligations) included in contracts with your suppliers?'),
(61,98,'Do you periodically review and update your supply chain risk assessments to address emerging threats?'),
...
(63,101,'How do you evaluate the effectiveness of your cybersecurity risk management measures? (Select all that apply)'),
(64,101,'Do you engage external audits or third-party assessments to validate the effectiveness of your cybersecurity measures?'),
(65,102,'Which of the following basic cyber hygiene practices are implemented in your organization? (Select all that apply)'),
(66,102,'Do you provide regular cybersecurity training to all employees?'),
(67,103,'Do you implement encryption to protect sensitive data both in transit and at rest?'),
(68,103,'Are internal communications and remote access channels secured using encryption (e.g., secure email, VPNs, encrypted messaging)?'),
(70,104,'Do you have formal onboarding and offboarding procedures to manage user accounts, ensuring that access rights are granted and revoked appropriately?'),
(71,104,'Does your organization enforce access control policies (such as least-privilege access) and maintain an updated inventory of assets and user accounts?'),
(72,104,'Is Multi-Factor Authentication (MFA) required for access to critical systems and sensitive data?'),
...
(13,'GDPR','General Data Protection Regulation survey',NULL,'2025-02-24 18:21:06'),
(14,'NIS2 Risk Management','European Union Directive 2022/2555 (NIS2)',NULL,'2025-02-24 18:21:06'),
(15,'27001','Your opinion matters in our workplace.',NULL,'2025-02-24 18:21:06'),
(25,'Among us meeting','We should decide who committed the crime....',NULL,'2025-03-04 20:24:13');
...
-- Dump completed on 2025-03-19 16:20:31
