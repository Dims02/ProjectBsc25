  ...
  <div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="bg-white shadow-md rounded-lg p-6">
      ...
      <p class="mt-2 text-gray-600">
        ...
        <a href="mailto:matos.silva@ubi.pt" class="text-indigo-600 hover:underline">
          matos.silva@ubi.pt
        </a>
      </p>
    </div>
        ...
        <div class="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              ...
              id="name"
              required
              class="block w-full rounded-md bg-white border border-gray-300 px-3 py-1.5 text-base
                     text-gray-900 placeholder:text-gray-400 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
            >
          </div>
          ...
          <div class="text-right">
            <button
              type="submit"
              class="px-4 py-2 rounded-md text-sm font-semibold hover:bg-opacity-80 <?= $highlightColor; ?>"
            >
              Send Message
            </button>
          </div>
