  ...
  <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8" >
    <div class="bg-white shadow-md rounded-lg p-6">
      ...
      <p class="mt-2 text-gray-600">
        ...
        organizations assess their adherence to cybersecurity regulations, such as the <strong>NIS2 Directive</strong> and <strong>GDPR</strong> as well as the Portuguese <strong>QNRCS</strong> (National Reference Board for Cyber Security).
      </p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mt-6">
      ...
      <ul class="list-disc list-inside mt-2 text-gray-600">
        <li>Intuitive survey creation as well as CRUD operations</li>
        <li>Tailored compliance recommendations</li>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mt-6">
      <h2 class="text-xl font-semibold text-gray-900">Supervision</h2>
      <p class="mt-2 text-gray-600">
